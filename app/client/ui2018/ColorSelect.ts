...
const translate = (x: string, args?: any): string => t(`ui2018.ColorSelect.${x}`, args);
...
export function colorSelect(
  ...
  const {
    ...
    onOpen,
    onRevert,
    placeholder = translate('DefaultCellStyle'),//'Default cell style',
  } = options;
