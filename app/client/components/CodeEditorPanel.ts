...
const translate = (x: string, args?: any): string => t(`CodeEditorPanel.${x}`, args);
  ...
  public buildDom() {
    ...
    return dom('div.g-code-panel.clipboard',
      ...
      dom.maybe(this._denied, () => dom('div.g-code-panel-denied',
        dom('h2', dom.text(translate('AccessDenied'))),
        dom('div', dom.text(translate('CodeViewOnlyFullAccess'))),
      )),
