...
const translate = (x: string, args?: any): string => t(`Importer.${x}`, args);
                ...
                return [
                  cssMergeOptions(
                    cssMergeOptionsToggle(labeledSquareCheckbox(
                      ...
                      translate('UpdateExistingRecords'),
                    ...
                    dom.maybe(updateExistingRecords, () => {
                      ...
                      return [
                        ...
                        multiSelect(
                          ...
                          {
                            placeholder: translate("SelectFieldsToMatch"),
