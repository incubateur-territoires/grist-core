...
const translate = (x: string, args?: any): string => t(`Tools.${x}`, args);
...
export function tools(owner: Disposable, gristDoc: GristDoc, leftPanelOpen: Observable<boolean>): Element {
  ...
  return cssTools(
    ...
    cssSectionHeader(translate("Tools")),
    cssPageEntry(
      ...
      dom.domComputed(canViewAccessRules, (_canViewAccessRules) => {
        return cssPageLink(
          cssPageIcon('EyeShow'),
          cssLinkText(translate('AccessRules'),
    ...
    cssPageEntry(
      ...
      cssPageLink(
        ...
        cssLinkText(translate('RawData')),
        testId('raw'),
        urlState().setLinkUrl({docPage: 'data'})
      )
    ),
    cssPageEntry(
      cssPageLink(cssPageIcon('Log'), cssLinkText(translate('DocumentHistory')), testId('log'),
    ...
    dom.maybe((use) => use(gristDoc.app.features).validationsTool, () =>
      cssPageEntry(
        cssPageLink(cssPageIcon('Validation'), cssLinkText(translate('ValidateData')), testId('validate'),
    ...
    cssPageEntry(
      ...
      cssPageLink(cssPageIcon('Code'),
        cssLinkText(translate('CodeView')),
    ...
    dom.maybe(docPageModel.currentDoc, (doc) => {
      ...
      return cssPageEntry(
        cssPageLink(cssPageIcon('Page'), cssLinkText(translate('HowToTutorial')), testId('tutorial'),
      ...
      cssSplitPageEntry(
        cssPageEntryMain(
          cssPageLink(cssPageIcon('Page'),
            cssLinkText(translate('DocumentTour')),
        ...
        !isDocOwner ? null : cssPageEntrySmall(
          cssPageLink(cssPageIcon('Remove'),
            dom.on('click', () => confirmModal(translate('DeleteDocumentTour'), translate('Delete'), () =>
  ...
  return [
    ...
    hoverTooltip((ctl) =>
      cssConvertTooltip(icon('Convert'),
        cssLink(translate('ViewingAsYourself'),
          urlState().setHref(userOverrideParams(null, {docPage: 'acl'})),
        ),
